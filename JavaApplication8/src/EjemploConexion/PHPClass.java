...
public class PHPClass {
    ...
    public boolean saveInfo(User user) {
        try {
            URL url = new URL("https://crustier-twists.000webhostapp.com/ChatT/saveInfo.php");
     ...
     */
    public List<User> getInfo() throws JSONException {
    ...
    private String getJSON() {
        ...
        try {
            ...
            url = "https://crustier-twists.000webhostapp.com/ChatT/getInfo.php";
            URL obj = new URL(url);
